...
const PrayerStartN: React.FC = () => {
  return (
    <div className={styles.page}>
      <p className={styles.instructions}>מי שלא היה בבית קברות במשך שלושים יום מברך ברכה זו בבואו תוך ד' אמות</p>
